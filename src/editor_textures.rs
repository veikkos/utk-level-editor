...
impl EditorTextures<'_> {
    pub fn new<'a>(context: &Context<'a>) -> EditorTextures<'a> {
        EditorTextures {
            p1_text_texture: render::get_font_texture(
                &context.texture_creator,
                &context.font,
                "PL1",
            ),
            p2_text_texture: render::get_font_texture(
                &context.texture_creator,
                &context.font,
                "PL2",
            ),
            ...
            place_normal_crate_text_texture: render::get_font_texture(
                &context.texture_creator,
                &context.font,
                "PLACE NORMAL GAME CRATE",
            ),
            place_deathmatch_create_text_texture: render::get_font_texture(
                &context.texture_creator,
                &context.font,
